  ...
  <div class="nav-wrapper white  ">
    ...
    <ul class="right">
      <li><a class="waves-effect waves-light btn modal-trigger grey lighten-4 grey-text text-darken-1" href="?c=<?php echo base64_encode('Usuario');?>&a=<?php echo base64_encode('Ver_datos_usuario');?>&idusuario=<?php echo base64_encode($_SESSION["id"]);?>" ><b>Cancelar</b><i class="material-icons right grey-text text-darken-1">arrow_back</i></a></li>
    </ul>
  </div>
  </nav>
  <br>
      ...
      <div class="card-panel white blue-text">
       <div class="section">
        ...
        <div class="row form-background">
          <form class="col s12" action="?c=<?php echo base64_encode('Usuario'); ?>&a=<?php echo base64_encode('ActualizarContraseñaa'); ?>" method="post">
            <div class="row top20px bottom20px">
             ...
             <!--<div class="input-field col s12 m12">
              <i class="material-icons prefix form-icon">https</i>
              <input id="n_passs1" type="password" class="validate" name="n_passs1" required>
              <label for="n_passs1">Clave Actual</label>
            </div>-->
