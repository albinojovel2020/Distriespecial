...
<nav>
    <div class="nav-wrapper white  ">
      <ul id="nav-mobile" class="left hide-on-med-and-down">
        <li ><a class="grey-text text-darken-1"><b>DISTRIBUIDORA ESPECIAL > INGRESO DE PRODUCTOS</b></a></li> 
    </ul>
    <ul class="right">
...
<div class="row">
    <div class="section">
      ...
      <div class="row">
          <div class="col s12">
            <ul class="tabs">
              <li class="tab col s3 m6 l3 yy"><a class="active tab-activos" href="#activos">EGRESOS POR VENTA</a></li>
          </ul>
      </div>
      <!-- tabla de activos -->
