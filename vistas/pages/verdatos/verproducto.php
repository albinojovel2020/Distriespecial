          ...
          <?php foreach($this->model->ListarProductosInactivos() as $r):?>
              <tr>
                ...
                <td><?php echo $r->nombreusuario; ?></td>
                 ...
                 <td class="center">
                       <a onclick="javascript:return confirm('¿Seguro que desea eliminar este registro?');" href="?c=<?php echo base64_encode('Producto'); ?>&a=<?php echo base64_encode('Eliminar'); ?>&idproducto=<?php echo base64_encode($r->idproducto); ?>" title="Eliminar Registro" ><i class="small material-icons red-text">delete</i></a>
                  </td>
              </tr>
          <?php endforeach; ?> 
