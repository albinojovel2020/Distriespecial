          ...
          <tbody>
              ...
              <?php foreach($this->model->ListarUsuariosActivos() as $r):?>
                  <tr>
                      ...
                      <td class="center">
                          <a href="?c=<?php echo base64_encode('Usuario'); ?>&a=<?php echo base64_encode('EditarUsuario'); ?>&id_usuario=<?php echo base64_encode($r->id_usuario); ?>" title="Editar Registro" ><i class="mini material-icons azul-ast-text hoverable circle ">edit</i></a>
                      </td>
                      <td class="center">
                          <a onclick="javascript:return confirm('¿Seguro que desea desactivar este registro?');" href="?c=<?php echo base64_encode('Usuario'); ?>&a=<?php echo base64_encode('CambiarEstado'); ?>&nuevo_estado=<?php echo base64_encode('0'); ?>&id_usuario=<?php echo base64_encode($r->id_usuario); ?>" title="Desactivar Registro" ><i class="material-icons red-text hoverable circle mini">cancel</i></a>
                      </td>
                  </tr>
              <?php endforeach; ?>    
      ...
      <tbody>
          ...
          <?php foreach($this->model->ListarUsuariosInactivos() as $r):?>
              <tr>
                  ...
                  <td>Tipo</td>
                  <td class="center">
                      <a onclick="javascript:return confirm('¿Seguro que desea activar este registro?');" href="?c=<?php echo base64_encode('Usuario'); ?>&a=<?php echo base64_encode('CambiarEstado'); ?>&nuevo_estado=<?php echo base64_encode('1'); ?>&idusuario=<?php echo base64_encode($r->id_usuario); ?>" title="Activar Registro"><i class="mini material-icons green-text hoverable circle">check_circle</i></a>
                  </td>
              </tr>
          <?php endforeach; ?> 
